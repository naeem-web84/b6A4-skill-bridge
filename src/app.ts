...
// ✅ FIXED CORS CONFIGURATION - Based on reference
...
app.use(
  cors({
    origin: (origin, callback) => {
      ...
      // Check if origin is in allowedOrigins or matches ANY Vercel deployment
      const isAllowed =
        allowedOrigins.includes(origin) ||
        /^https:\/\/skill-bridge-client.*\.vercel\.app$/.test(origin) || // Your specific pattern
